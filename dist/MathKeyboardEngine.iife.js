var mke = (() => {
  ...
  __export(bundle_exports, {
    Atom: () => Atom,
    DecimalSeparatorAtom: () => DecimalSeparatorAtom,
    DeleteCurrent: () => DeleteCurrent,
    DeleteSelection: () => DeleteSelection,
    DigitAtom: () => DigitAtom,
    GetEditModeLatex: () => GetEditModeLatex,
    GetViewModeLatex: () => GetViewModeLatex,
    Insert: () => Insert,
    ...
    MoveRight: () => MoveRight,
    MoveUp: () => MoveUp,
    MultiplePlaceholdersAscendingRawAtom: () => MultiplePlaceholdersAscendingRawAtom,
    MultiplePlaceholdersDescendingRawAtom: () => MultiplePlaceholdersDescendingRawAtom,
    MultiplePlaceholdersRawAtom: () => MultiplePlaceholdersRawAtom,
    Placeholder: () => Placeholder,
    RawAtom: () => RawAtom,
    ReadonlyAtom: () => ReadonlyAtom,
    RoundBracketsAtom: () => RoundBracketsAtom,
    SelectLeft: () => SelectLeft,
    SelectRight: () => SelectRight,
    SinglePlaceholderRawAtom: () => SinglePlaceholderRawAtom,
    TryInsertWithEncapsulateCurrent: () => TryInsertWithEncapsulateCurrent,
    TryInsertWithEncapsulateSelection: () => TryInsertWithEncapsulateSelection,
    WritableAtom: () => WritableAtom
  });
